...
export default function Footer() {
  ...
  const exploreLinks = [
    { label: nav("fragrances"), href: `/${locale}#fragrances` },
    { label: nav("whyUs"), href: `/${locale}#why-us` },
    { label: nav("locations"), href: `/${locale}/locations` },
  ];
  ...
  return (
    <footer className="bg-navy text-white/60 pt-20 pb-10 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-5">
            ...
            <p className="font-serif text-sm text-white/30 italic mt-4">
              {t("tagline")}
            </p>
          </div>
          ...
          <div className="md:col-span-2 md:col-start-7">
            <h4 className="text-[11px] font-medium tracking-[0.25em] uppercase text-white/30 mb-4">
              {t("explore")}
            </h4>
